...
export const CodeEditor = async () => {
  ...
  const editorsToday = Array.isArray(todayRes?.data?.editors) ? todayRes.data.editors : [];
  ...
  const editors7d = Array.isArray(stats7dRes?.data?.editors) ? stats7dRes.data.editors : [];
