...
import { RiReactjsLine, RiHtml5Fill, RiBootstrapFill } from 'react-icons/ri'
...
const data = [
  {
    ...
    list: [
      ...
      {
        title: 'Codeigniter',
        href: '/projects?tag=Codeigniter',
        icon: <SiCodeigniter className='w-4 h-4' />
      },
      {
        title: 'Bootstrap',
        href: '/projects?tag=Bootstrap',
        icon: <RiBootstrapFill className='w-4 h-4' />
      },
      {
        title: 'HTML',
