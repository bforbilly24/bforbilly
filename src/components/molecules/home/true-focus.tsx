...
const TrueFocus: React.FC<TrueFocusProps> = ({ sentence = 'True Focus', manualMode = false, blurAmount = 5, borderColor = 'hsl(var(--foreground))', glowColor = 'hsla(var(--foreground), 0.6)', animationDuration = 0.5, pauseBetweenAnimations = 1 }) => {
			...
			{words.map((word, index) => {
				...
				return (
					<span
						...
						className='relative cursor-pointer text-base text-muted-foreground sm:text-xl md:text-2xl'
						style={
							{
