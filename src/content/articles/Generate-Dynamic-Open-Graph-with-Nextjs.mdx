...
<figure>
  <img src="/articles/Generate-Dynamic-Open-Graph-With-Nextjs/preview.png" alt="Telegram showing additional data using OG" title="Telegram showing additional data using OG" />
